			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="contact-form-warp">
						<h4 class="comment-title">Buat akun</h4>
						<form class="comment-form" action="daftar.php" method="post">
							<div class="row">
								<div class="col-md-12">
									<input type="text" name="nama" placeholder="Nama Lengkap" requeired>
								</div>
								<div class="col-md-12">
								...
								<div class="col-lg-12">
									<input type="submit" name="Submit" value="Buat Akun" class="site-btn btn-sm">
								</div>
							</div>
							<?php
							if (isset($_POST['Submit'])) {
								...
								$result = mysqli_query($mysqli, "INSERT INTO akun(nama,username,password) VALUES ('$nama','$username','$password')");
								echo "Berhasil buat akun! <a href='masuk.php'>Masuk akun</a>";
							}
							?>
						</form>
